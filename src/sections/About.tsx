    ...
    <section id="about" className="py-section-mobile lg:py-section px-6 overflow-hidden">
      <div className="mx-auto max-w-7xl">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="font-display text-2xl font-semibold text-charcoal">12+</div>
                  <div className="text-sm text-taupe">Années d'excellence</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <span className="text-sm font-medium text-gold uppercase tracking-widest">À propos</span>

            <h2 className="mt-4 font-display text-4xl md:text-5xl font-semibold leading-tight text-charcoal text-balance">
              Là où la vision rencontre l'exécution parfaite
            </h2>

            <p className="mt-6 text-lg text-taupe leading-relaxed">
              Fondée avec une passion pour créer des moments extraordinaires, Pella est devenue
              une agence événementielle de premier plan, reconnue pour son souci du détail et
              son approche innovante.
            </p>

            <p className="mt-4 text-taupe leading-relaxed">
              Notre équipe de professionnels créatifs réunit expertise en design,
              logistique et hospitalité pour offrir des expériences fluides qui dépassent
              les attentes. Du concept à la réalisation, nous gérons chaque détail avec
              précision et soin.
            </p>
            ...
            <div className="mt-10 grid sm:grid-cols-2 gap-6">
              {[
                { icon: '✦', title: 'Vision créative', desc: 'Concepts uniques adaptés à votre histoire' },
                { icon: '◆', title: 'Équipe experte', desc: 'Professionnels leaders du secteur' },
                { icon: '●', title: 'Souci du détail', desc: 'Rien n\'est laissé au hasard' },
                { icon: '▲', title: 'Organisation sereine', desc: 'Nous gérons tout pour vous' },
              ].map((feature, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
